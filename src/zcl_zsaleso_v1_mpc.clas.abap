class ZCL_ZSALESO_V1_MPC definition
  public
...
public section.
  ...
  types:
          SHIPADDRESS type ZST_SHIPADDRESS .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSALESO_V1_MPC============CP' ##NO_TEXT.
...
CLASS ZCL_ZSALESO_V1_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSALESO_V1_SRV' ).
...
* Navigation Properties for entity - Customers
lo_entity_type = model->get_entity_type( iv_entity_name = 'Customers' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'CustomersToOrdersNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'CUSTOMERSTOORDERSNAV' "#EC NOTEXT
                                                              iv_association_name = 'CustomersToOrders' ). "#EC NOTEXT
* Navigation Properties for entity - Orders
lo_entity_type = model->get_entity_type( iv_entity_name = 'Orders' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OrdersToCustomersNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ORDERSTOCUSTOMERSNAV' "#EC NOTEXT
                                                              iv_association_name = 'CustomersToOrders' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OrdersToPaymentsNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'ORDERSTOPAYMENTSNAV' "#EC NOTEXT
                                                              iv_association_name = 'OrdersToPayments' ). "#EC NOTEXT
* Navigation Properties for entity - Payments
lo_entity_type = model->get_entity_type( iv_entity_name = 'Payments' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'PaymentsToOrdersNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'PAYMENTSTOORDERSNAV' "#EC NOTEXT
                                                              iv_association_name = 'OrdersToPayments' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESO_V1_MPC=>TS_BRFSHCUSTOMID' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_complex_type->create_property( iv_property_name  = 'Buildernumber' iv_abap_fieldname = 'BUILDERNUMBER' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name   = 'ZST_SHIPADDRESS'
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESO_V1_MPC=>TS_CONFIRMORDER' ). "#EC NOTEXT
...
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 20 ). "#EC NOTEXT
lo_property->set_semantic( 'tel' ). "#EC NOTEXT
lo_property->set_creatable( abap_true ).
lo_property->set_updatable( abap_true ).
lo_property->set_sortable( abap_false ).
lo_property->set_nullable( abap_false ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESO_V1_MPC=>TS_ORDERLIST' ). "#EC NOTEXT
...
lo_complex_type = lo_entity_type->create_complex_property( iv_property_name = 'Shipaddress'
                                                           iv_complex_type_name = 'Shipaddress'
                                                           iv_abap_fieldname    = 'SHIPADDRESS' ). "#EC NOTEXT
lo_property = lo_entity_type->create_property( iv_property_name = 'Orderid' iv_abap_fieldname = 'ORDERID' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 10 ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZST_ORDERS_CT'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20231223102844'.                  "#EC NOTEXT
